...
public class AmfiService {
	...
	{
		var context = SpringApplication.run(AmfiService.class, args);
		ConfigurableEnvironment env = (ConfigurableEnvironment) context.getEnvironment();
		String activeProfile = env.getActiveProfiles().length > 0 ? env.getActiveProfiles()[0] : "default";

		if (activeProfile.equalsIgnoreCase("prod"))
		{
			System.out.println("✅ AMFI Server Production started!");
		} else if (activeProfile.equalsIgnoreCase("dev"))
		{
			System.out.println("✅ AMFI Server Development started!");
		} else
		{
			System.out.println("✅ AMFI Server "+activeProfile+" started!");
		}
	}
	...
	public OpenAPI customOpenAPI() {
		...
		return new OpenAPI()
				...
				.info(new Info()
						.title("AMFI Service API")
						.version("v1.0")
						.description("""
                            This API handles AMFI-related operations.
	...
	public class FallbackController
	{
		...
		@RequestMapping("/")
		public String home() {
			return "Welcome to Easternfin - Microservice AMFI Seervice!";
		}
	}
}