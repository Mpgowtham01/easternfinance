...
public class AESEncryptionUtilV2 {
    ...
    public static String base64EncodedAuth(String apiSecret, String licenseKey, String loginUserId) throws Throwable {

        int randomNumber = (int)(Math.random() * 10000000000L);
        String plainText = apiSecret + "|" + randomNumber;
        String encryptedPassword = encrypt(plainText, licenseKey);
        System.out.println("encryptedPassword: " + encryptedPassword);

        String combinedloginUserIdEncryptedPassword = loginUserId + ":" + encryptedPassword;
