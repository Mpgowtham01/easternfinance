...
public class UserDto {
    ...
    public boolean isIs_purchase_allowed() {
        return is_purchase_allowed;
    }

    public boolean isIs_redeem_allowed() {
        return is_redeem_allowed;
    }

    public boolean isIs_switch_allowed() {
        return is_switch_allowed;
    }

    public boolean isIs_stp_allowed() {
        return is_stp_allowed;
    }
