...
public class NseRegistrationMapper {
    ...
    public JSONObject buildRegistrationJson(UserDto userDto, String primary_holder_kyc_type, String primary_holder_ckyc_number, String second_holder_kyc_type, String second_holder_ckyc_number, String third_holder_kyc_type, String third_holder_ckyc_number, String guardian_kyc_type, String guardian_ckyc_number, String nomination_authentication) {

        JSONArray regDetailsArray = new JSONArray();
        JSONObject regObject = new JSONObject();
        System.out.println("soa1 ==== " + userDto.getBank_account_type1());
...
// prepared kyc variables
        ...
        String nominee_opt = userDto.getNominee_opt();
        nominee_opt = (nominee_opt==null? "":nominee_opt.trim());

        List<String> nominationOptTaxStatusList = Arrays.asList ("02","03", "04", "06", "07", "08", "13", "10", "47", "26", "28");
        if(nominationOptTaxStatusList.contains(tax_status) || nominee_opt.equalsIgnoreCase("N"))
        {
        ...
        {
            regObject.put("nomination_opt", nominee_opt);
            ...
            regObject.put("nominee_soa", StringUtils.defaultString(userDto.getNominee_soa()));
        }
